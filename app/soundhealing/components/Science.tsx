    ...
    <div className='grid grid-cols-1 md:grid-cols-3 gap-2'>
      {facts.map((fact) => (
         <div className='border rounded'>
          <p className='font-bold text-xl'>{fact.fact}</p>
         <p>{fact.information}</p></div>
      ))}
