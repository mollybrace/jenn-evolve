...
<section> 
    ...
    <div className="flex flex-col mt-0 md:flex-row md:space-x-2 text-white">
        <div className="flex flex-col   items-center p-6 m-6 space-y-6 rounded-lg md:w-1/3 bg-khaki-green bg-opacity-50  md:m-0 md:ml-2">
        ...
        <div className="flex flex-col md:m-0   items-center p-6 m-6 space-y-6 rounded-lg md:w-1/3 bg-khaki-green text-white bg-opacity-50">
            <div className='image-container'>
                <Image 
                    src="/backgroundImage.jpg"
                    alt="profile photo"
        ...
        <div className="flex flex-col md:m-0 items-center p-6 m-6 space-y-6 rounded-lg bg-khaki-green text-white bg-opacity-50 md:w-1/3 md:mr-2">
            <div className='image-container'>
                <Image 
                    src="/backgroundImage.jpg"
                    alt="profile photo"
