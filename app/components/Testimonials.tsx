...
const Testimonials = () => (
  ...
  >
    ...
    <div className="w-full flex justify-between items-center md:flex-row flex-col sm:mb-16 mb-6 relative z-[1]">
      <h2
        className={`font-poppins font-semibold xs:text-[48px] text-[40px] text-black xs:leading-[76.8px] leading-[66.8px] w-full md:justify-center md:items-center`}
      >
        What People are saying about me <br className="sm:block hidden" /> 
      </h2>
