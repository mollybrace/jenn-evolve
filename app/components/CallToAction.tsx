...
const CallToAction = () => {
  return (
     <div className="bg-[url('/calltoaction.jpg')] h-[500px] w-full bg-no-repeat bg-center bg-cover relative">
        ...
        <button className='mt-10 p-4 bg- rounded-lg bg-khaki-beige font-bold border text-lg shadow hover:bg-carmine md:text-3lg' type='button'><a href="/contact">Join Here</a></button>
        </div>
            </div>
  )
}
