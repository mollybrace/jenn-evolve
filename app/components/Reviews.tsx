    ...
    <div className="px-6 m-6 border flex justify-center items-center text-center flex-col bg-khaki-cream rounded-lg md:h-[300px] lg:mx-20 lg:h-[250px] ">
     ...
     <div className='flex justify-around pb-5'>
        ...
        onClick={prevSlide}>
          ...
          <path stroke="#3A271Bff" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m15 19-7-7 7-7"/>
          </svg>
        </button>
...
onClick={nextSlide}>
  <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
  <path stroke="#3A271Bff" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m9 5 7 7-7 7"/>
  </svg>
</button>
